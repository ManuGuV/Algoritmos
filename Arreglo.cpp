...
public:
    ...
    void bucketSort()
    {
        ...
        cout << endl << "Se aplicó bucketSort" << endl;
    }
    ...
    void countingSort()
    {
        ...
        cout << endl << "Se aplicó countingSort" << endl << endl;
    }
      ...
      void mergeSort(int lo, int hi)
      {
        if(hi<=lo)//a menos que hi sea menor que lo no va a salirse de la recursión
        {
          ...
          cout << endl << "Se aplicó mergeSort" << endl << endl;
      }
    ...
    void shellSort()
    {
        ...
        cout << endl << "Se aplicó shellSort" << endl << endl;
    }
    ...
    void SelectionSort() //método de ordenamiento selection sort
      {
          ...
          cout << endl << "Se aplicó selectionSort" << endl << endl;
      }
    ...
    void quickSort(int inicio, int fin) //método de ordenamiento QuickSort
    {
        ...
        cout << endl << "Se aplicó quickSort" << endl << endl;
    }
};
...
int main()
{
    ...
    //a1.bucketSort();
    //a1.countingSort();
    //a1.mergeSort(0, a1.getTam()-1);
    //cout << a1.binaryTreeSort() << "ms" << endl;
    //a1.radixSort();
    //a1.shellSort();
    //a1.SelectionSort();
    //a1.HeapSort();
    //a1.quickSort(0, a1.getTam()-1);
    tiempo = clock() - tiempo;
    cout << endl;
    a1.printArr();
